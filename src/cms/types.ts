...
export type CmsState = {
  ...
  franchise:{
    hero:{image:CmsAsset;kicker:string;title:string;accent:string;intro:string;cta:string;index:string;country:string};
    opportunity:{index:string;label:string;title:string;accent:string;text:string;cta:string};
    includes:{index:string;label:string;title:string;accent:string;items:{icon:string;title:string;text:string}[]};
    investment:{image:CmsAsset;index:string;label:string;title:string;accent:string;items:{value:string;unit:string;label:string}[];note:string};
    journey:{index:string;label:string;title:string;accent:string;items:{number:string;title:string;text:string}[]};
